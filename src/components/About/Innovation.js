export default function Innovation() {
  ...
  return (
    <section className="pt-48 bg-gradient-to-r from-[#401D60] via-[#271A73] to-[#1F1B5A] py-20 px-8">
      ...
      <div className="w-1/2 mt-24 mx-auto flex flex-col items-center py-20">
