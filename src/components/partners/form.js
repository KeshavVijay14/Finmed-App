...
export default function PartnerForm() {
  return (
    <div className="flex justify-center items-center h-screen    bg-gradient-to-r from-[#401D60] via-[#271A73] to-[#1F1B5A]">
      <div className="w-[80%] flex gap-20 items-center ">
        <div className="w-[1/2]">
          ...
          <p className="text-white mb-6 font-light text-base font-roboto">
            Partner with us to grow your business and offer your clients the
            financial solutions they are looking for.
            <br />
