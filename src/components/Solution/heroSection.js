          ...
          >
            <div>
              ...
              <p className="font-thin text-sm text-white max-w-lg font-roboto">
                ...
                institutions and lenders with access to a secure platform. With
                Finmed, you can accurately establish the value of healthcare
                insurance receivables while streamlining approval and onboarding
                processes.
              </p>
            </div>
            <div className="grid grid-cols-3 py-8 pl-32 pr-20 max-w-md gap-20 gradient-background">
              <Image
