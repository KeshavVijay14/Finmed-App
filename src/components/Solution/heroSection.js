    ...
    <InView triggerOnce threshold={0.5}>
      {({ inView, ref, entry }) => (
        <div>
          ...
          >
            <div
              className={`w-full max-w-7xl flex flex-col md:flex-row justify-around items-center h-screen p-4 ${
                inView ? "animate-scale-opacity-z" : ""
              }`}
            >
              <div className="text-center md:text-left">
                <h1 className="text-4xl md:text-4xl font-bold mb-4 text-[#62D89F] font-trebuchet">
                  Creating Endless Lending Possibilities
                </h1>
                <p className="font-thin text-base md:text-lg text-white max-w-xl mx-auto md:mx-0">
