    ...
    <div className="bg-gradient-to-r from-[#401D60] via-[#271A73] to-[#1F1B5A] justify-center flex">
      <div className=" flex gap-10 w-[80%] items-center py-10 my-20">
        ...
        <div className="relative h-[440px] flex-grow">
          ...
          <div className="absolute right-80 top-16 rounded shadow-sm p-3  border-0">
            <Image
          ...
          <div className="absolute right-28 top-4 rounded shadow-sm p-3  border-0">
            <Image
          ...
          <div className="absolute right-[100px] bottom-8 rounded shadow-sm p-3  border-0">
            <Image
              src="/images/step5.svg"
              alt="Icon 2"
              width={20}
          ...
          <div className="absolute right-[340px] bottom-12 rounded shadow-sm p-3  gradient-border">
            <Image
              src="/images/step3.svg"
              alt="Icon 2"
              width={20}
          ...
          <div className="absolute right-[440px] top-48 rounded shadow-sm p-3 ">
            <Image
